        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 transform transition hover:-translate-y-1 hover:shadow-md duration-300">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-bold text-gray-500 uppercase tracking-wide">{{ __('Total Documentos') }}</h3>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 transform transition hover:-translate-y-1 hover:shadow-md duration-300">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-bold text-gray-500 uppercase tracking-wide">{{ __('Aprobados') }}</h3>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 transform transition hover:-translate-y-1 hover:shadow-md duration-300">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-bold text-gray-500 uppercase tracking-wide">{{ __('Pendientes') }}</h3>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 transform transition hover:-translate-y-1 hover:shadow-md duration-300">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-bold text-gray-500 uppercase tracking-wide">{{ __('Rechazados') }}</h3>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="p-6 border-b border-slate-200 flex justify-between items-center bg-slate-50/50">
                    <h3 class="text-lg font-extrabold text-gray-900">{{ __('Actividad Reciente') }}</h3>
                    <a href="{{ route('documents.index') }}" class="text-sm font-bold text-indigo-600 hover:text-indigo-900">{!! __('Ver Todos &rarr;') !!}</a>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider bg-gray-50 rounded-tr-lg">{{ __('Fecha de Creación') }}</th>
                            </tr>
                        </thead>
